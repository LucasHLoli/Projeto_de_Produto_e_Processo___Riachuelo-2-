...
No nível B2B, o cliente externo corresponde às redes de moda do segmento-alvo definido na Seção~\ref{subsec:segmento_alvo}, pois serão elas que decidirão a aquisição e pagarão pela solução. A Riachuelo, cliente do projeto e mercado obtível no curto prazo, serve de referência para o desenvolvimento, e outros varejistas do segmento com necessidades semelhantes poderão adotar o mesmo sistema.
...
Já nessa observação inicial, a preferência entre autonomia e atendimento assistido pareceu variar conforme o momento da jornada e o grupo de consumidor. Por isso, a equipe evitou tratar a autonomia como vantagem automática, o que poderia levar a uma solução que retira o suporte justamente quando o cliente ainda precisa dele.
