...
\begin{titlepage}
    \begin{center}
        ...
        \vspace*{\fill}
        {\fontsize{20}{24}\selectfont\bfseries Autoatendimento no varejo de moda}\\[10pt]
        {\fontsize{14}{18}\selectfont sistema antifurto com pagamento pelo aplicativo\\[2pt] e liberação pelo próprio cliente}
