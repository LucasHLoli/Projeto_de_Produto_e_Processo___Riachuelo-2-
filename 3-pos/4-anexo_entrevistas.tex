...
\phantomsection
\section*{ANEXO B \textendash{} TRANSCRIÇÃO DAS ENTREVISTAS}
\label{anexo:entrevistas}
\addcontentsline{toc}{section}{ANEXO B \textendash{} TRANSCRIÇÃO DAS ENTREVISTAS}

Transcrições das onze entrevistas individuais semiestruturadas descritas na Seção~\ref{subsec:entrevistas}, conduzidas com o roteiro do \hyperref[anexo:roteiro_entrevistas]{Anexo A}.

\phantomsection
\subsection*{Entrevista 1}
\addcontentsline{toc}{subsection}{Entrevista 1}
...
\addcontentsline{toc}{subsection}{Entrevista 2}
...
\addcontentsline{toc}{subsection}{Entrevista 3}
...
\addcontentsline{toc}{subsection}{Entrevista 4}
...
\phantomsection
\subsection*{Entrevista 5}
\addcontentsline{toc}{subsection}{Entrevista 5}
...
\phantomsection
\subsection*{Entrevista 6}
\addcontentsline{toc}{subsection}{Entrevista 6}
...
\phantomsection
\subsection*{Entrevista 7}
\addcontentsline{toc}{subsection}{Entrevista 7}
...
\phantomsection
\subsection*{Entrevista 8}
\addcontentsline{toc}{subsection}{Entrevista 8}
...
\phantomsection
\subsection*{Entrevista 9}
\addcontentsline{toc}{subsection}{Entrevista 9}
...
\phantomsection
\subsection*{Entrevista 10}
\addcontentsline{toc}{subsection}{Entrevista 10}
...
\phantomsection
\subsection*{Entrevista 11}
\addcontentsline{toc}{subsection}{Entrevista 11}
